...
<?php } else { ?>
	<div class="et-price-button et-product-on-sale">
		<?php
			$et_price_before_output = $et_price_before;
			$et_price_sale_output   = $product->get_price();
			if ( function_exists( 'wp_price' ) ) {
				$et_price_before_output = wp_price( $et_price_before );
				$et_price_sale_output   = wp_price( $product->get_price() );
			}
		?>
		<span class="et-price-before"><del><?php echo $et_price_before_output; ?></del></span>
		<span class="et-price-sale"><?php echo $et_price_sale_output; ?></span>
	</div>
<?php }
	endwhile;
	rewind_posts();
